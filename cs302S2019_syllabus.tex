...
web sites during the laboratory and practical sessions and a design portfolio.
...
\begin{itemize}
  ...
  \item {\em Class Participation\/}: All students are required to actively
    ...
    course's Slack team. A student may request feedback on and will receive a
  ...
  \item {\em Design Portfolio\/}: This project will furnish you with the
    description of a web development task and ask you to specify, design,
    ...
    to publicly release their web sites.
...
the required name. Unless specified otherwise, all of assignments must be turned
